...
class MediaCatalogue:
    ...
    def __str__(self):
        ...
        if series:
            result += "=== TV SERIES ===\n"
            for N, single_series in enumerate(series, 1):
                result += f"{N}. {single_series}\n"
        return result
...
try:
    ...
    movie2 = Movie("Batman Begins", 2005, "Christopher Nolan", 140)
    catalogue.add(movie2)

    series1 = TVSeries("Formula 1: Drive to Survive", 2019, "Martin Webb", 40, 8, 78)
    catalogue.add(series1)
    series2 = TVSeries("Slow Horses", 2022, "James Hawes", 45, 5, 30)
