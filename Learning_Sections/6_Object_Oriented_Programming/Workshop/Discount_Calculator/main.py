...
if __name__ == "__main__":
    product1 = Product("Wireless Mouse", 50.0)
    user_tier1 = "Premium"
    ...
    engine = DiscountEngine(strategies1)
    best_price = engine.calculate_best_price(product1, user_tier1)

    print(f"Best price for {product1.name} for {user_tier1} user: ${best_price:0.2f}")
